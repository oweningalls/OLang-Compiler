...
public class Lr1ParserTests
{
    ...
    public void TestParseOLangGrammarSnippet()
    {
        ...
        var bDeclarationStatement = new FunctionDeclaration(new IntType(), new IdentifierToken("b"), bScope);
    ...
    //     var statementList = (StmtListWithStatement)program.ClassMemberList;
